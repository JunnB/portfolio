...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez mon portfolio de développeur junior, présentant mes compétences, projets et expériences dans le domaine du développement web.",
  keywords:
    "développeur junior, portfolio, projets web, compétences en programmation",
  ...
  twitter: {
    ...
    title: "Portfolio de Développeur Junior",
    description:
      "Découvrez mes réalisations en tant que développeur web junior",
  },
}
